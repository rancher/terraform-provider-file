...
Examples:
  .gemini/skills/create-pr.sh --title "fix: logic error" --body "Fixes the loop bounds"
  .gemini/skills/create-pr.sh --title "feat: new helper" --body "Adds skill" --draft
  .gemini/skills/create-pr.sh --ready
  .gemini/skills/create-pr.sh --ready 280
EOF
}
