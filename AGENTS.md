...
- **Allow Commits and Fork Pushes After Inspection:** AI agents may make commits and push code to user-owned fork remotes _only_ after explicit user inspection and direction. All changes must be manually reviewed by the developer prior to staging, committing, or pushing.
