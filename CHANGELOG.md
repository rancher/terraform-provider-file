...
## [2.4.2](https://github.com/rancher/terraform-provider-file/compare/v2.4.17...v2.4.2) (2026-09-24)
...
* add turn budget accounting and modularize agent test suites ([#437](https://github.com/rancher/terraform-provider-file/issues/437)) ([8068a1b](https://github.com/rancher/terraform-provider-file/commit/8068a1ba5971a99075c05a1eb4f4202d258eb2bf))
...
* **agent:** implement three-tier async architecture and multi-gate cryptographic gating ([#423](https://github.com/rancher/terraform-provider-file/issues/423)) ([4f99980](https://github.com/rancher/terraform-provider-file/commit/4f9998028a6fc4468898807a8d8fef8836cba328))
...
* clean up framework for portability ([#430](https://github.com/rancher/terraform-provider-file/issues/430)) ([784e804](https://github.com/rancher/terraform-provider-file/commit/784e804f6d6cec3becff1b2a4a0dde2476e29456))
...
* Enforce Fail-Closed Security, Cryptographic Signing, and Error Handling Gating ([45b2805](https://github.com/rancher/terraform-provider-file/commit/45b2805007591d85d8bfb6972c1a975db8b76370))
* Enforce Fail-Closed Security, Cryptographic Signing, and Error Handling Gating ([45b2805](https://github.com/rancher/terraform-provider-file/commit/45b2805007591d85d8bfb6972c1a975db8b76370))
...
* Feature/toml docs migration ([#429](https://github.com/rancher/terraform-provider-file/issues/429)) ([6d338f9](https://github.com/rancher/terraform-provider-file/commit/6d338f960dfe0b90af3ceef8351dab491334e235))
* Fix commit gate ([#427](https://github.com/rancher/terraform-provider-file/issues/427)) ([25b2164](https://github.com/rancher/terraform-provider-file/commit/25b2164a5e069eb89ffb7d54a70f300f5f042947))
...
* **framework:** implement hook error recovery and active gate revocation ([#406](https://github.com/rancher/terraform-provider-file/issues/406)) ([f89ac23](https://github.com/rancher/terraform-provider-file/commit/f89ac2388fe9e9039e156887a80a142b177af06d))
...
* harden max turns error detection and circular reference handling ([#438](https://github.com/rancher/terraform-provider-file/issues/438)) ([b062e97](https://github.com/rancher/terraform-provider-file/commit/b062e974e199a4b2220d33c90e49755d0c3b93c0))
* harden orchestrator security boundaries ([#435](https://github.com/rancher/terraform-provider-file/issues/435)) ([c92ce48](https://github.com/rancher/terraform-provider-file/commit/c92ce486f0933c86a85796e1b28eb3672872a12a))
* improve JSON parsing, async logging, and diff hashing ([#436](https://github.com/rancher/terraform-provider-file/issues/436)) ([be14b85](https://github.com/rancher/terraform-provider-file/commit/be14b85885178557c86de634f99d2712e5690b1f))
...
* introduce quality-assurance script ([#426](https://github.com/rancher/terraform-provider-file/issues/426)) ([19adc25](https://github.com/rancher/terraform-provider-file/commit/19adc25fb6a70dc50a8d7af323f0868a8d776e60))
...
* move docs to their proper locations and fix links ([#424](https://github.com/rancher/terraform-provider-file/issues/424)) ([4e6e2b4](https://github.com/rancher/terraform-provider-file/commit/4e6e2b4dd780f0469b8246d448c277e3cd30dd9e))
...
* prevent quality gate bypasses and update system policies ([#425](https://github.com/rancher/terraform-provider-file/issues/425)) ([fbc964b](https://github.com/rancher/terraform-provider-file/commit/fbc964b1c384672d019f4d764475a7e7c152a5bb))
...
* refactor agentic framework ([#432](https://github.com/rancher/terraform-provider-file/issues/432)) ([eb24659](https://github.com/rancher/terraform-provider-file/commit/eb246594c3714dffee2163b9ea3297da7e2564ce))
...
* resolve critical review comments and validate hooks ([#420](https://github.com/rancher/terraform-provider-file/issues/420)) ([a58903f](https://github.com/rancher/terraform-provider-file/commit/a58903f5f5031f99eaf2175673d002edddf8acfd))
...
* resolve lint and test errors ([#434](https://github.com/rancher/terraform-provider-file/issues/434)) ([be52786](https://github.com/rancher/terraform-provider-file/commit/be527868ac4cb596f56b63f7637ec6b946fe1a9e))
...
* strip system.md to communication rules and fix promise path bug ([#428](https://github.com/rancher/terraform-provider-file/issues/428)) ([46aabbb](https://github.com/rancher/terraform-provider-file/commit/46aabbb981a3b88109893d4807e7db509548d8fa))
...
* use octal escapes for non-printing characters in dynamic prompt ([#417](https://github.com/rancher/terraform-provider-file/issues/417)) ([c0d94b5](https://github.com/rancher/terraform-provider-file/commit/c0d94b550886e36d80630481412a97e2b26392f3))
