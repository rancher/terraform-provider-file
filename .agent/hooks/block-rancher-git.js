  ...
  if (isManipulatingApproval) {
    console.log(JSON.stringify({
      ...
      reason: "Security Policy Violation: Manually writing, editing, or spoofing the proactive review approval file is strictly prohibited.\n\n" +
              "The approval file must ONLY be generated by executing the dedicated secure repository skill:\n" +
              "-> `.agent/skills/write-approval.sh -t TOKEN -d DIFF_HASH -m \"MESSAGE\"`.\n\n" +
              "This skill securely validates active One-Time Pad (OTP) tokens and enforces restricted permissions.",
