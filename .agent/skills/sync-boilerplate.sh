...
Examples:
  .agent/skills/sync-boilerplate.sh --diff
  .agent/skills/sync-boilerplate.sh --pull
  .agent/skills/sync-boilerplate.sh --push
  .agent/skills/sync-boilerplate.sh --status
EOF
}
