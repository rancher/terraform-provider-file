...
- **Collaboration:** Instead of generating a new plan, you MUST _edit_ and _adapt_ the existing plan, modifying its top-half architectural blueprint and expanding its bottom-half implementation checklist to encompass the new requirements, modifications, or bug fixes.
